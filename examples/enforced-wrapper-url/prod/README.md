This folder contains environment-specific variable overrides for the `enforced-wrapper-url` example (prod).

Sensitive values are not committed to the repository. To use this example:
